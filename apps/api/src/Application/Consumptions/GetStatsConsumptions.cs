...
public record GetStatsConsumptionsResponseWrapper(List<ConsumptionStatsResponse> Stats);
...
public static class GetStatsConsumptionsHandler
{
    ...
    private static ConsumptionStatsResponse CalculateStats(string type, string unit, string color, int selectedYear, string selectedMonth,
        List<Domain.Entities.Consumption> selectedYearEnergies, List<Domain.Entities.Consumption> comparisonYearEnergies)
    {
