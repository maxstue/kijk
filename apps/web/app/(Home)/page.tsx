          ...
          <div className='bg-background relative overflow-hidden rounded-lg border p-2'>
            <div className='flex h-[180px] flex-col justify-between rounded-md p-6'>
              ...
              <div className='space-y-2'>
                ...
                <p className='text-muted-foreground text-sm'>App dir, Routing, Layouts, Loading UI and API routes.</p>
              </div>
            </div>
          </div>
          <div className='bg-background relative overflow-hidden rounded-lg border p-2'>
          ...
          <div className='bg-background relative overflow-hidden rounded-lg border p-2'>
            <div className='flex h-[180px] flex-col justify-between rounded-md p-6'>
              ...
              <div className='space-y-2'>
                ...
                <p className='text-muted-foreground text-sm'>Authentication using Clerk.</p>
              </div>
            </div>
          </div>
          <div className='bg-background relative overflow-hidden rounded-lg border p-2'>
