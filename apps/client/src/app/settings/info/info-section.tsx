...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@kijk/ui/components/accordion";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">
          Here are some informations about this app and privacy settings.
        </p>
      </div>
      <Separator />
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded border p-4">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Enable cookies to enhance your experience. We use them to analyze site
                        traffic. Rest assured, all data collected is anonymized.
                      </FormDescription>
                    </div>
                    <FormControl>
        ...
        <div>
          <Accordion collapsible type="single" className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                If you wish to have your personal data deleted from our systems in accordance with
                the &rsquo;Right to be Forgotten&rsquo; under GDPR or similar regulations, you can
                submit a request by contacting us through {siteConfig.email}. Once we verify your
                identity, we will proceed to remove your personal data from our active databases and
                stop further processing. You will receive a confirmation once the deletion is
                complete. Please note that certain data may be retained as required by law or for
