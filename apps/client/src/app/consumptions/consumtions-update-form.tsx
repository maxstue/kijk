...
function NameField({
  ...
  field: ControllerRenderProps<ConsumptionUpdateFormSchema, "name">;
}) {
  return (
    <FormItem>
...
function ValueField({
  ...
  field: ControllerRenderProps<ConsumptionUpdateFormSchema, "value">;
}) {
...
function ValueTypeField({
  ...
  field: ControllerRenderProps<ConsumptionUpdateFormSchema, "valueType">;
}) {
  return (
    <FormItem>
...
function ResourceField({
  ...
  field: ControllerRenderProps<ConsumptionUpdateFormSchema, "resourceId">;
}) {
  const { data } = useGetResources();
  return (
    <FormItem>
...
function DateField({
  ...
  field: ControllerRenderProps<ConsumptionUpdateFormSchema, "date">;
}) {
  return (
    <FormItem>
